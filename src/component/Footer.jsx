            ...
            <div className="mt-6">
              <div>
                ...
                <input
                  ...
                  className="block w-full p-4 text-white placeholder-gray-500 transition-all duration-200 bg-transparent border border-gray-800 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600"
                />
              </div>
