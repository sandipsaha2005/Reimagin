...
export function LinkPreviewDemo() {
  return (
      ...
      <div className="px-5 md:flex flex flex-wrap gap-3 justify-around items-center invert">
        ...
        <img
          ...
          // alt="Equals"
          className="md:h-12 h-8 md:mx-4 grayscale hover:grayscale-0 transition duration-300"
        />
        </LinkPreview>{" "}
        ...
        <img
          ...
          alt="Felt"
          className="md:h-12 h-8 mx-4 grayscale hover:grayscale-0 transition duration-300"
        />
        </LinkPreview>{" "}
